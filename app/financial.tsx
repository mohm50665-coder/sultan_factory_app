...
const styles = StyleSheet.create({
  ...
  areaRow: { width: "100%", maxWidth: 1180, alignSelf: "center", flexDirection: "row", justifyContent: "center", gap: 10, paddingHorizontal: 16, paddingVertical: 12 },
  tabs: { width: "100%", maxWidth: 1180, alignSelf: "center", gap: 10, paddingHorizontal: 16, paddingBottom: 10, justifyContent: "center" },
  tab: { minWidth: 112, paddingHorizontal: 10, paddingVertical: 9, borderWidth: 1, borderRadius: 12, alignItems: "center", gap: 4 },
  content: { width: "100%", maxWidth: 1180, alignSelf: "center", paddingHorizontal: 18, paddingTop: 8, paddingBottom: 100 },
  summary: { borderWidth: 1, borderRadius: 14, padding: 18, marginBottom: 14, alignItems: "center" },
  ...
  choiceRow: { flexDirection: "row", flexWrap: "wrap", justifyContent: "center", gap: 8, marginBottom: 8 },
