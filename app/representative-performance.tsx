...
export default function RepresentativePerformanceScreen() {
  ...
  const moduleCardWidth = windowWidth >= 1200 ? "31.5%" : windowWidth >= 680 ? "47.5%" : "100%";
  const { user } = useAuth();
