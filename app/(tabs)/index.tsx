...
const DASHBOARD_ITEMS: DashboardItem[] = [
  ...
  },
  {
    ...
    icon: "fact-check",
    color: "#2563eb",
    route: "/representative-approvals",
  ...
  {
    id: "financial",
    labelAr: "الشؤون الإدارية والمالية",
    labelEn: "Administrative & Financial Affairs",
    icon: "payments",
    color: "#6366f1",
    route: "/financial",
    descriptionAr: "المالية: البنك والمصروفات والعهد والتقرير اليومي — الإدارة: الأعمال والجدول والتقرير",
    descriptionEn: "Finance: bank, expenses, custodies and daily report — Administration: work, schedule and report",
    section: "financial",
